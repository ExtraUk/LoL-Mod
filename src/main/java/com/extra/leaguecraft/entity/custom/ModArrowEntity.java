...
public class ModArrowEntity extends AbstractArrowEntity {
    ...
    public ModArrowEntity(EntityType<? extends ArrowEntity> type, World worldIn) {
        super(type, worldIn);
    }

    public ModArrowEntity(World worldIn, double x, double y, double z) {
        super(EntityType.ARROW, x, y, z, worldIn);
    }

    public ModArrowEntity(World worldIn, LivingEntity shooter) {
    ...
    protected void onEntityHit(EntityRayTraceResult result) {
        ...
        if(result.getEntity() instanceof LivingEntity){
            ...
            if(entity.isEntityUndead()){
                result.getEntity().attackEntityFrom(DamageSource.GENERIC, 7.0F);
            }
        }
    ...
    public void setPotionEffectDamageUndead() {
        this.potion = ModEffects.DAMAGE_UNDEAD_POTION.get();
    }
